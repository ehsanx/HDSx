...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, leftrule=.75mm, coltitle=black, colback=white, titlerule=0mm, rightrule=.15mm, opacityback=0, bottomrule=.15mm, breakable, toprule=.15mm, arc=.35mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, opacitybacktitle=0.6, left=2mm, toptitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, leftrule=.75mm, coltitle=black, colback=white, titlerule=0mm, rightrule=.15mm, opacityback=0, bottomrule=.15mm, breakable, toprule=.15mm, arc=.35mm, colframe=quarto-callout-tip-color-frame, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, opacitybacktitle=0.6, left=2mm, toptitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, leftrule=.75mm, coltitle=black, colback=white, titlerule=0mm, rightrule=.15mm, opacityback=0, bottomrule=.15mm, breakable, toprule=.15mm, arc=.35mm, colframe=quarto-callout-warning-color-frame, colbacktitle=quarto-callout-warning-color!10!white, bottomtitle=1mm, opacitybacktitle=0.6, left=2mm, toptitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Tester note}, leftrule=.75mm, coltitle=black, colback=white, titlerule=0mm, rightrule=.15mm, opacityback=0, bottomrule=.15mm, breakable, toprule=.15mm, arc=.35mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, opacitybacktitle=0.6, left=2mm, toptitle=1mm]
...
You may also submit a structured slide outline for A8. The revealjs path
is recommended if you want practice with Quarto slides before M5.
...
Or open \texttt{starter-slides.qmd} in RStudio or VS Code and click
Render.
...
Before release, render
\texttt{weeks/week09-science-communication/starter-slides.qmd} in a
clean Codespace and confirm that the title slide, source note, and
bibliography entry appear.
...
Check that the file names below match the current Assignment 8 README
before release.
...
Render \texttt{weeks/week10-reporting-publishing/report-template.qmd}
and confirm the \texttt{@cdc-nhanes} citation resolves in the reference
list.
...
Check that the file names below match the current Assignment 9 and M3
README files before release.
...
The optional \href{static-dashboard-ojs.qmd}{static dashboard source}
remains a demo-only example. It is not a required A10 or final portfolio
pathway.
...
Before release, run this protocol on a clean fork or clean Codespace and
check that the steps match the current GitHub Codespaces interface.
...
The file \url{static-dashboard-ojs.qmd} demonstrates a no-server
dashboard that reads the NHANES CSV snapshot in the browser. It is
useful as an optional portfolio extension after the required report and
...
Check that the file names below match the current Assignment 10 and
Final Portfolio README files before release.
