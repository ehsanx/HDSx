...
| 9 | Scientific communication, revealjs slides, peer feedback | `weeks/week09-science-communication/index.qmd` | Partial | Add a fuller revealjs activity, plain-language summary practice, and peer review template. |
| 10 | Reproducible reporting, publishing, citations, GitHub Pages | `weeks/week10-reporting-publishing/index.qmd`; `weeks/week10-reporting-publishing/report-template.qmd`; `references.bib` | Partial | Report template exists; continue tightening citation and publishing guidance. |
| 11 | Portfolio reproducibility stress test, optional deployment | `weeks/week11-portfolio-surgery/index.qmd`; `reproducibility-test.qmd`; `static-dashboard-ojs.qmd` | Partial | Fresh-session testing and static dashboard demo exist; continue refining advanced deployment choices. |
...
2. Weeks 1 and 6-8 now have complete NHANES-aligned teaching packs; later communication, reporting, portfolio, and presentation weeks still need routine refinement.
...
3. Continue refining Weeks 9-13 now that Weeks 6-8 have complete exemplars.
