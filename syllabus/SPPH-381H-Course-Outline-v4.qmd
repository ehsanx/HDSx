...
<!-- AI-EDIT(2026-07-08): course moved Thu -> Tue (SPPH reschedule, R3-01/OPS-002). First class Tue Sep 15 (Sep 8 = Imagine UBC, no undergrad classes); Tue Nov 10 = mid-term break. The 11 teaching Tuesdays (Sep 15 - Dec 1) hold content Weeks 1-11; in-class presentations (old Weeks 12-13) are removed and the presentation (former Milestone 5) is folded into the Final Portfolio as a required narrated slide deck — kept visible as Presentation 10% + Portfolio 35%, one Dec 11 deadline. Deadlines recomputed (M3 draft Mon Nov 23, M4 peer review Mon Nov 30 — a full-week review window; Week 11 / Dec 1 is a deadline-free feedback + portfolio-surgery session; Final Portfolio Dec 11 unchanged). OPEN: SPPH must confirm the 39-contact-hour treatment (11 x 3h = 33h synchronous). Book-wide follow-ups + open items in tue-reschedule-book-todo.md -->
...
6.  **.gitignore configured:** Rendered outputs, OS junk, and sensitive files are excluded from version control. One named exception: the Assignment 8, Assignment 9, and Milestone 3 submission folders do commit rendered HTML for grading; everywhere else, rendered outputs stay excluded. <!-- AI-EDIT(2026-06-11): MIT-100 (D-006) — rendered-HTML grading exception — needs review -->
