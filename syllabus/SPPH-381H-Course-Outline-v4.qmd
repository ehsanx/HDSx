...
UBC's Point Grey Campus is located on the traditional, ancestral, and unceded territory of the xwməθkʷəy̓əm (Musqueam) people. The land it is situated on has always been a place of learning for the Musqueam people, who for millennia have passed on their culture, history, and traditions from one generation to the next on this site.
...
schedule <- data.frame(
  ...
  Seminar = c(
    "—",
    "Health Data, KT & Ethics: research lifecycle overview; KT 'last mile'; privacy/security; Indigenous Data Sovereignty (OCAP®, CARE); AI hallucinations & bias (AI fluency ≠ correctness).",
    ...
    "R with AI (Code runs ≠ code is correct): data import/export; core constructs (objects, functions, control flow); the tidyverse pipeline; debugging with LLMs; writing custom functions; intro to renv for dependency management.",
