...
schedule <- data.frame(
  ...
  Seminar = c(
    ...
    "R with AI (Code runs does not mean code is correct): data import/export; core constructs (objects, functions, control flow); the tidyverse pipeline; debugging with LLMs; writing custom functions; intro to renv for dependency management.",
