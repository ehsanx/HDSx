...
UBC's Point Grey Campus is located on the traditional, ancestral, and unceded territory of the xwmÉ™Î¸kÊ·É™yÌ“É™m (Musqueam) people. The land it is situated on has always been a place of learning for the Musqueam people, who for millennia have passed on their culture, history, and traditions from one generation to the next on this site.
...
info <- data.frame(
  ...
  Details = c(
    ...
    "Thu 11:00 AM â€“ 2:00 PM (Septâ€“Dec 2026)",
    "TBD (In-person)"
  )
)
...
All supported coding takes place in **GitHub Codespaces** â€” a cloud computer accessible from any modern web browser. No local installation is required. Students **fork** a course template repository into their own GitHub account, then launch Codespaces from their fork. 
...
2.  **Reproducible Science:** Git-based workflows, environment management (`renv`), and literate programming in Quarto â€” ensuring analyses are transparent, shareable, and robust.
...
4.  **Knowledge Translation (KT):** The "last mile" of data science â€” transforming results into dashboard-style products, visual stories, plain-language summaries, and policy-ready reports. Shiny and static web approaches are introduced as optional or advanced pathways rather than assumed for every project.
...
*This takes approximately 15â€“20 minutes and ensures Week 1 can focus entirely on health data concepts rather than account setup.*
...
schedule <- data.frame(
  ...
  Seminar = c(
    "â€”",
    "Health Data, KT & Ethics: research lifecycle overview; KT 'last mile'; privacy/security; Indigenous Data Sovereignty (OCAPÂ®, CARE); AI hallucinations & bias (AI fluency â‰  correctness).",
    ...
    "R with AI (Code runs â‰  code is correct): data import/export; core constructs (objects, functions, control flow); the tidyverse pipeline; debugging with LLMs; writing custom functions; intro to renv for dependency management.",
    ...
    "Writing & Publishing Reports: scientific formatting in Quarto; dynamic reporting; embedding interactive elements; enabling GitHub Pages; publishing your portfolio; citation/grounding audit. Note: UBC Mid-Term Break is Nov 9â€“11; class meets as usual on Thu Nov 12.",
...
### Weekly Assignments (Weeks 2â€“11)
...
-   **Assignments 1â€“3 (Weeks 2â€“4) are required but worth 0% numerically.** These foundational assignments (Codespace/Quarto, R basics, Git) are graded on a Complete/Incomplete basis. Each must be completed to pass the course. Incomplete submissions may be resubmitted once within one week. A student who completes A1â€“A3 and otherwise earns at least 50% on the graded components will pass.
-   **Assignments 4â€“10 (Weeks 5â€“11): Best 5 of 7 count.** Only your best 5 scores count toward your final grade. This provides flexibility for difficult weeks while ensuring consistent engagement after the foundation is established. Assignment 6 includes a dedicated AI-audit task involving planted errors in AI-generated code, summaries, and/or visualizations.
...
|-------------------------|-----------------|------------------------------|
| **M0: Group Formation** | Week 4 (Mon) | Form project group of 3â€“4 students; one member forks template and adds teammates as collaborators |
...
| **M5: Presentation** | Weeks 12â€“13 | In-class scientific seminar; knowledge translation focus |
...
assess <- data.frame(
  Component = c(
    "Foundational Assignments (Weeks 2â€“4)",
    "Weekly Assignments (Best 5 of 7, Weeks 5â€“11)",
  ...
  Notes = c(
    ...
    "In-class scientific seminar (Weeks 12â€“13)",
...
-   **Foundational Assignments (1â€“3):** May be resubmitted once within one week of the original deadline.
-   **Weekly Assignments (4â€“10):** Due Mondays at 4 PM unless otherwise noted. Late submissions are not accepted. Missed assignments count as one of your dropped grades (Best 5 of 7 policy).
...
-   **Always stop your Codespace** when you finish working ([github.com/codespaces](https://github.com/codespaces) â†’ three dots â†’ Stop). Leaving a tab open wastes credits.
...
A key goal of this course is to ensure you leave with more than just a grade. By the end of the term, you will have a public-facing **Data Science Portfolio** hosted on GitHub Pages featuring real-world health data analysis â€” a tangible asset for your CV or LinkedIn.
