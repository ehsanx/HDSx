...
1. Open the `.qmd` file you want to render, then go to **View → Command Palette** and run **Quarto: Render Document**. The Quarto extension renders the file and opens a preview pane.
