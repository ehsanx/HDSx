...
For the course workspace, ignore machine-specific files, secrets, `.quarto/`,
and temporary `*_files/` support directories. Do not globally ignore `*.html`
or `*.pdf`: when an assessment explicitly requires a rendered artifact, that
file must be committed with its source.
