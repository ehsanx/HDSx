...
4.  Each member makes a small "hello" commit (e.g., add your name to the `README.md`) and pushes it to verify access.

::: callout-note
**Milestone 0 due Friday:** Record your group formation on Canvas and ensure everyone can commit to the shared repository.
:::
