...
5.  For now, review the diff on GitHub, then click **Merge pull request** → **Confirm merge**.
...
1.  **One member** creates the group repository from the GitHub Classroom link (provided on Canvas).
2.  All other members accept the invitation and clone the repo by launching a Codespace from it.
3.  As a group, agree on norms:
...
4.  Each member makes a small "hello" commit (e.g., add your name to the `README.md`) and pushes it to confirm access.

::: callout-note
**Milestone 0 due Friday:** Confirm your group formation on Canvas and ensure everyone can commit to the shared repository.
:::
