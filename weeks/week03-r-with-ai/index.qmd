...
The personal workspace devcontainer is the supported course environment. It
installs the R and Python packages used by the required pathway, so you do not
need to initialize `renv`, create a lockfile, or install packages for Assignment
2.
...
4. If you think you need another package, ask the instructor or TA before adding
   it. Record an approved addition in the workspace devcontainer setup and in
   your dependency note so a fresh Codespace can reproduce it.
...
Full instructions: [Assignment 2 README](../../assignments/assignment02-r-with-ai/README.md). Short version: [Assignment 2 walkthrough](r09-assignment-mad-libs.qmd).
