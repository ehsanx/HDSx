...
::: {.callout-note}
If you see an error like `there is no package called 'tidyverse'`, the package is not installed in your Codespace. Ask your TA --- this should be pre-configured.
:::
