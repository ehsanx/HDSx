...
::: {.callout-note title="Tester note"}
Capture: a screenshot of the rendered scatter plot. Confirm the axis labels read "Age (years)" and "Weight (kg)" so students can compare against their own first attempt.
:::
