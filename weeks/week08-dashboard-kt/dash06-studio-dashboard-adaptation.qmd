...
2. You copied the personal-workspace starter to
   `assignments/assignment07-dashboard/submission/dashboard.qmd`, and that copy
   renders cleanly with the default `selected_income`.
...
Edit `assignments/assignment07-dashboard/submission/dashboard.qmd` with the
revised text. Then run the six-step test routine from
[dash05](dash05-testing-privacy-and-shiny-demo.qmd):
...
<!-- AI-EDIT(2026-06-22): tester-note-conversion — converted leaked "Tester note" callout to hidden HTML comment (preserved for instructors/testers; redundant with the required screenshot output already listed for students). -->
<!--
Tester note:
