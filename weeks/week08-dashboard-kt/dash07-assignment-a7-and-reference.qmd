...
All eight files are [required]. The [A7 README](../../assignments/assignment07-dashboard/README.md) marks the brief ones with [brief — 1-3 focused bullets or sentences are enough]; the full tag vocabulary is in [How To Read Submission Lists](../../assignments/index.qmd#how-to-read-submission-lists).
