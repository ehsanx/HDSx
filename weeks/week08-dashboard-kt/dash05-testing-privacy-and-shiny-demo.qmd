...
1. **Render from the personal-workspace root.** Copy the workspace starter to
   `assignments/assignment07-dashboard/submission/dashboard.qmd`, open that
   submitted copy, and render it from the Command Palette (**Quarto: Render
   Document**). Confirm there are no errors. <!-- AI-EDIT(2026-06-11): MIT-078 — needs review -->
...
The starter uses only packages in the course devcontainer. If an additional
package is approved, record it in the workspace setup and your dependency note,
then repeat the test in a fresh Codespace.
:::
