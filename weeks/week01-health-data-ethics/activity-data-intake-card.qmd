...
<!-- AI-EDIT(2026-06-11): SS-005 — figure placeholder, RA to capture -->
<!-- TODO-SCREENSHOT: uncomment when the asset exists:
![A completed Data Intake Card with direct links to the source page, documentation, and citation guidance](../../assets/images/week01/intake-card-filled.png){fig-alt="Filled-in Data Intake Card showing every field completed, with the clickable source and documentation links highlighted"}
-->
...
<!-- AI-EDIT(2026-06-11): SS-006 — figure placeholder, RA to capture -->
<!-- TODO-SCREENSHOT: uncomment when the asset exists:
