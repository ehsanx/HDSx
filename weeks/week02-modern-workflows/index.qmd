...
*Deeper Dive: [The Analogy: Public Computer vs Cloud Drive](workflows01-cloud-drive.qmd).* <!-- AI-EDIT(2026-06-11): GAP-MBH-3 — needs review --><!-- AI-EDIT(2026-06-22): REVIEW-row26,row27 — link label normalized to "Deeper Dive" (consistency rename) -->
...
- **Crucial difference:** Saved changes remain in that Codespace when it stops,
  but they are not in your GitHub repository until you commit and sync them. A
  Codespace can later be deleted, so GitHub—not the Codespace—is the safe home
  for finished work.
...
*Deeper Dive: [Tour of the Repository](workflows02-repository-tour.qmd).* <!-- AI-EDIT(2026-06-11): GAP-MBH-3 — needs review --><!-- AI-EDIT(2026-06-22): REVIEW-row26,row27 — link label normalized to "Deeper Dive" (consistency rename) -->
...
*Deeper Dive: [Opening Your First Codespace](workflows03-open-codespace.qmd) and [Reopening a Codespace](workflows04-reopen-codespace.qmd).* <!-- AI-EDIT(2026-06-11): GAP-MBH-3 — needs review --><!-- AI-EDIT(2026-06-22): REVIEW-row26,row27 — link label normalized to "Deeper Dive" (consistency rename) -->
...
*Deeper Dive: [VS Code Orientation](workflows05-vscode-orientation.qmd).* <!-- AI-EDIT(2026-06-11): GAP-MBH-3 — needs review --><!-- AI-EDIT(2026-06-22): REVIEW-row26,row27 — link label normalized to "Deeper Dive" (consistency rename) -->
...
*Deeper Dive: [Files vs Folders](workflows06-files-folders.qmd).* <!-- AI-EDIT(2026-06-11): GAP-MBH-3 — needs review --><!-- AI-EDIT(2026-06-22): REVIEW-row26,row27 — link label normalized to "Deeper Dive" (consistency rename) -->
...
*Deeper Dive: [The Magic Moment: Render Quarto](workflows07-render-quarto.qmd).* <!-- AI-EDIT(2026-06-11): GAP-MBH-3 — needs review --><!-- AI-EDIT(2026-06-22): REVIEW-row26,row27 — link label normalized to "Deeper Dive" (consistency rename) -->

### Step 1: Open the Starter File

<!-- AI-EDIT(2026-06-22): REVIEW-row36 (TF-010,WI-014,D-003) — say where practice_report.qmd lives so students can find it in the Explorer -->
...
<!-- AI-EDIT(2026-06-22): REVIEW-row35 (GAP-MBH-3) — add embed-resources: true so the downloaded HTML contains the generated plots/images (RA's 'embedded resources : true' corrected to the proper Quarto key 'embed-resources: true') -->
```yaml
---
...
<!-- FINAL-CHECK(2026-08-24): corrected render semantics: save first; a full Quarto render executes chunks without a separate Run All prerequisite -->
**Before you render:** save the file with `Ctrl+S` (`Cmd+S` on macOS). Rendering
runs the code chunks from the start and captures their results, so you do not
need to run every chunk first. Running chunks interactively is still useful for
finding errors before a full render.
...
In your personal workspace, `practice_report.html` is saved beside
`practice_report.qmd` at the repository root. Watch the render log for the
`Output created:` line, then right-click the HTML file and choose **Open
Preview** or **Download**. The course book uses a separate `docs/` output
directory; your personal workspace does not.
:::
...
*Deeper Dive: [Commit Your Work](workflows08-commit-work.qmd).* <!-- AI-EDIT(2026-06-11): GAP-MBH-3 — needs review --><!-- AI-EDIT(2026-06-22): REVIEW-row26,row27 — link label normalized to "Deeper Dive" (consistency rename) -->
...
*Deeper Dive: [Stop Your Codespace](workflows10-stop-codespace.qmd).* <!-- AI-EDIT(2026-06-11): GAP-MBH-3 — needs review --><!-- AI-EDIT(2026-06-22): REVIEW-row26,row27 — link label normalized to "Deeper Dive" (consistency rename) -->

GitHub Free personal accounts currently include 120 core-hours per month. On
the course's default 2-core machine, that is about 60 hours of active runtime.
**If you leave the browser tab open, the meter keeps running** until the
Codespace reaches its idle timeout, even if you are not actively working.
...
*Deeper Dive: [Troubleshooting: Rebuild Container](workflows09-troubleshooting.qmd).* <!-- AI-EDIT(2026-06-11): GAP-MBH-3 — needs review --><!-- AI-EDIT(2026-06-22): REVIEW-row26,row27 — link label normalized to "Deeper Dive" (consistency rename) -->
...
Edit and render the supplied root-level `practice_report.qmd`, demonstrating
that you can navigate your personal workspace Codespace, edit Quarto, and
commit your work. This is the same authoritative workflow as the
[Assignment 1 brief](../../assignments/assignment01-workflows/README.md); there
is no separate nested A1 submission.
...
9. **Submit** your personal workspace repository link on Canvas. The synced
   commit must include the root-level `practice_report.qmd` and
   `practice_report.html`; no extra reflection or commit-evidence file is
   required.
