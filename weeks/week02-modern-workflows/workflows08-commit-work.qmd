...
2.  Stage the two Assignment 1 files

    -   Hover over `practice_report.qmd` and `practice_report.html`, then click
        the **+** beside each file.
    -   Check the **Staged Changes** list before continuing. Do not stage
        unrelated files.
...
5.  Click **Sync Changes** (or **Push**)
    ...
    -   *Note:* You might be asked to click "Always" or "Yes" to approve the
        sync.
