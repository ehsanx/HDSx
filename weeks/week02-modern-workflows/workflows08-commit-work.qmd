...
1.  Click the **Source Control** icon
    ...
    ![Source control icon circled in red](../../assets/images/workflow8/button.png)
...
2.  Type a **Commit Message**
    ...
    ![This is required](../../assets/images/workflow8/message.png)
...
3.  Click **Commit and Sync** (or Commit and Push)
    ...
    -   *Note:* You might be asked to click "Always" or "Yes" to confirm the sync.
