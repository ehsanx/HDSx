...
One warning that does **not** need a rebuild: "no TeX installation was found." That one is harmless as long as your HTML file was created — see the TeX Warning rule in [Render with Quarto](workflows07-render-quarto.qmd). <!-- AI-EDIT(2026-06-11): TF-054 — needs review -->
