...
If you need an account, open <https://github.com/signup> and follow GitHub's
account-creation prompts. If you already have an account, sign in at
<https://github.com/login> and confirm that you can reach your profile.
...
<!-- AI-EDIT(2026-06-30): SS-002/SS-003 — RA captured these figures (Week 0-3 screenshot batch); removed the now-obsolete TODO-SCREENSHOT / NEEDS-RA-SCREENSHOT placeholder comments since the assets now exist and are referenced -->
...
![Choosing the correct Owner on the Create a new fork page](../../assets/images/week00/SS-002-01-fork-creation.png){fig-alt="GitHub Create a new fork page with the Owner dropdown set to the student's own account"}

![Confirming the fork was created under your own account](../../assets/images/week00/SS-002-02-fork-confirmation.png){fig-alt="GitHub repository page showing forked from ehsanx/HDSx-workspace beneath the student's username"}
...
<!-- AI-EDIT(2026-09-01): optional course screencast (YouTube ID: qvGlBWptajs) — HTML-only so the PDF/DOCX build is unaffected -->
::: {.content-visible when-format="html"}
## Video walkthrough (optional) {.unnumbered}

{{< video https://youtu.be/qvGlBWptajs >}}
:::
