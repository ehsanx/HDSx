...
- Planted-error starter (the artifact you will audit): `weeks/week07-eda-ai-audit/instructor/planted-error-starter.qmd`
...
<!--
Instructor-only note (not rendered to students):
This page intentionally does NOT link to instructor/planted-error-key.md.
See weeks/week07-eda-ai-audit/instructor/MAINTENANCE.md for release-time key-handling steps.
-->
