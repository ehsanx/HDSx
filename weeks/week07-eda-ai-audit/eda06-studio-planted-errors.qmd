...
3. Render `eda03-worked-example.qmd` so you have a clean reference. The check passes when the HTML file is created and the table/plot are visible without errors. Record any error message in your notes. <!-- AI-EDIT(2026-06-11): GAP-R678-2, MIT-073 — needs review -->
