...
::: {.callout-tip title="Looking for due dates?"}
The [Assignment Schedule](schedule.qmd) lists every assignment and milestone in date order, marks which are individual and which are group work, and links to each brief.
:::
