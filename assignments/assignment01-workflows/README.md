...
This assignment checks that your course workflow is working before the analysis weeks begin. You will launch or reopen a GitHub Codespace, edit a Quarto document, render output, commit and sync your work, and stop the Codespace when you are finished.

## Learning Objectives

- Launch or reopen the correct Codespace for the course repository.
...
1. Open the course repository in GitHub Codespaces.
2. Create the folder `assignments/assignment01-workflows/submission/`.
3. Create a Quarto file named `workflow-check.qmd` in that folder.
4. Add a YAML title, your name, and the date.
5. Add one short paragraph explaining why relative paths matter in this course.
6. Add one code chunk that prints the current working directory or lists the files in the submission folder.
7. Render `workflow-check.qmd` to HTML.
8. Use the Source Control panel to inspect the diff.
9. Commit with a clear message such as `Complete Assignment 1 workflow check`.
10. Sync/push the commit to GitHub.
11. Stop the Codespace after confirming the commit appears on GitHub.
12. Write a short reflection naming one workflow step that felt solid and one step you want to practice.
...
- The final files must be committed and synced.
...
- Codespace was launched or reopened successfully.
...
- Work is committed and synced to GitHub.
...
You are done when the repository link on Canvas points to a synced commit containing `workflow-check.qmd`, `workflow-check.html`, `reflection.md`, and `commit-evidence.md` in the Assignment 1 submission folder.
